            ...
            <div class="panel-body">
                ...
                <form action="" class="form-horizontal" enctype="multipart/form-data" wire:submit.prevent="updateProduct">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="file" placeholder="Product Name" class="form-control input-md" wire:model="newimage"/>
                            @if($newimage)
                                <img src="{{ $newimage->temporaryUrl() }}" style="width:120px" alt="">
                            @else
                                <img src="{{ asset('assets/images/products') }}/{{ $image }}" alt="" style="width: 120px">
                            @endif
                        </div>
                    </div>
