        ...
        <div class="container">
            ...
            <div class="wrap-breadcrumb">
                <ul>
                    ...
                    <li class="item-link"><span>{{ $categories->category_name }}</span></li>
                </ul>
            </div>
            <div class="row">
                                ...
                                <li class="col-lg-4 col-md-6 col-sm-6 col-xs-6 ">
                                    <div class="product product-style-3 equal-elem ">
                                        ...
                                        <div class="product-info">
                                            ...
                                            <a href="#" class="btn add-to-cart" wire:click.prevent="store('{{ $item->id }}', '{{ $item->name }}', '{{ $item->regular_price }}')">Thêm vào giỏ hàng</a>
                                        </div>
                                    </div>
                                </li>
                            @endforeach
                            ...
                            <ul class="list-category">
                                @foreach($categories as $item)
                                    <li class="category-item">
                                        <a href="{{ route('product.category', ['category_slug' => $item->category_slug]) }}" class="cate-link">{{ $item->category_name }}</a>
                                    </li>
                                @endforeach
                            </ul>
                        </div>
