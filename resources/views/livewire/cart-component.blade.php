                ...
                @if(Cart::instance('cart')->count() > 0)
                    ...
                    <div class="order-summary">
                        ...
                        @if(Session::has('coupon'))
                            <p class="summary-info"><span class="title">Discount ({{ Session::get('coupon')['code'] }})</span> <a href="" wire:click.prevent="removeCoupon" class="fa fa-times text-danger"></a><b class="index"> -${{ number_format($discount, 2) }}</b></p>
                        ...
                        <div class="checkout-info">
                            @if(!Session::has('coupon'))
                                ...
                                @if($haveCouponCode == 1)
                                    <div class="summary-item">
                                        <form action="" wire:submit.prevent="applyCouponCode">
                                            <h4 class="coupon-box">Coupon Code</h4>
                                ...
                                @endif
                                <a class="btn btn-checkout" wire:click.prevent="checkout" href="#">Check out</a>
                                ...
                                <li class="pr-cart-item">
                                    ...
                                    <div class="delete">
                                        <a href="#" class="btn btn-delete" title="" wire:click.prevent="deleteFromSaveForLater('{{ $item->rowId }}')">
                                            <span>Delete from save for late</span>
                                            <i class="fa fa-times-circle" aria-hidden="true"></i>
                                        </a>
                                    </div>
                                </li>
